...
__device__ float my_current_spiking_injection_kernel(
  ...
  for (int param_label = 0; param_label < synaptic_data->num_parameter_sets; param_label++){
    float decay_factor = synaptic_data->decay_factors[param_label];
    float synaptic_current = synaptic_data->neuron_inputs.circular_input_buffer[prev_bufferloc + param_label + idx*synaptic_data->num_parameter_sets];
    float current_inc = synaptic_data->neuron_inputs.circular_input_buffer[bufferloc + param_label + idx*synaptic_data->num_parameter_sets];
    ...
    synaptic_data->neuron_inputs.circular_input_buffer[prev_bufferloc + param_label + idx*synaptic_data->num_parameter_sets] = 0.0f;
    synaptic_data->neuron_inputs.circular_input_buffer[bufferloc + param_label + idx*synaptic_data->num_parameter_sets] = synaptic_current;
  }
...
__device__ float my_voltage_spiking_injection_kernel(
  ...
  float total_current = 0.0f;
  for (int param_label = 0; param_label < synaptic_data->num_parameter_sets; param_label++){
    float input_current = synaptic_data->neuron_inputs.circular_input_buffer[bufferloc + param_label + idx*synaptic_data->num_parameter_sets];
    if (input_current != 0.0f){
      total_current += input_current;
      synaptic_data->neuron_inputs.circular_input_buffer[bufferloc + param_label + idx*synaptic_data->num_parameter_sets] = 0.0f;
    }
  }
