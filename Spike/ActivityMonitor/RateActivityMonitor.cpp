...
void RateActivityMonitor::state_update(unsigned int current_time_in_timesteps, float timestep, unsigned int timestep_grouping) {
  backend()->add_spikes_to_per_neuron_spike_count(current_time_in_timesteps, timestep, timestep_grouping);
}

void RateActivityMonitor::final_update(unsigned int current_time_in_timesteps, float timestep, unsigned int timestep_grouping){
